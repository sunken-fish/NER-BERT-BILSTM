...
Options:
    ...
    --model-save-path=<file>            model save path [default: ./model.pth]
    --optimizer-save-path=<file>        optimizer save path [default: ./optimizer.pth]
    --cuda                              use GPU
"""
...
def train(args):
    ...
    model = bert.BertCRF( tag_vocab, float(args['--dropout-rate']), int(args['--embed-size']),
    ...
    print("Batch size: ", args['--batch-size'])
    print("learning rate: ", args['--lr-decay'])
